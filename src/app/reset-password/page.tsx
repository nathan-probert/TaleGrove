      ...
      <div className="w-full max-w-md bg-background rounded-xl shadow-lg p-8 border border-grey4">
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-grey2 text-sm mt-2">Enter your new password</p>
          </div>
            ...
            {(error || success) && (
              <div
                className={`p-3 text-sm rounded-lg border ${
                  error
                    ? "text-primary bg-grey5 border-grey4"
                ...
                <div className="flex items-center">
                  <svg
                    className={`w-5 h-5 mr-3 ${
                      error ? "text-primary" : "text-green-600"
                    }`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                  ...
                  <span>
                    {error || "Password updated successfully! Redirecting..."}
                  </span>
                </div>
              </div>
            )}
